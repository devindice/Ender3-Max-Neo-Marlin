...
#define PIDTEMPBED  // Ender Configs
  ...
  #define DEFAULT_bedKi 76.39
  #define DEFAULT_bedKd 1335.09
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96 }  // Ender Configs
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -1.80 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define X_MIN_POS -24  // MRiscoC Stock physical limit
#define Y_MIN_POS -4  // MRiscoC Stock physical limit
#define Z_MIN_POS 0
#define X_MAX_POS 305  // MRiscoC Stock physical limit
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 40              // Set Mesh bounds as an inset region of the bed  // MRiscoC Center mesh
...
#define NOZZLE_PARK_FEATURE  // MRiscoC Enabled
  ...
  #define NOZZLE_PARK_POINT { -15, (Y_MAX_POS), 20 }
